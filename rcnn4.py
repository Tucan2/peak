...
class EncodingCNN(nn.Module):
    def __init__(self):
        ...
        self.encoding = nn.Sequential(
            ...
            nn.Conv1d(in_channels=2, out_channels=16, kernel_size=5, padding=2), nn.LazyBatchNorm1d(),
...
class RecurrentCNN(nn.Module):
    def __init__(self):
        ...
        self.LSTM = nn.LSTM(32, 32, batch_first=True, bidirectional=False)
        self.LSTM2 = nn.LSTM(32, 32, batch_first=True, bidirectional=False)
        self.classifier = nn.Linear(32, 2)
        self.integrator = nn.Linear(32, 2)
    ...
    def forward(self, x):
        #if ever initalizing params, look into He initilization
